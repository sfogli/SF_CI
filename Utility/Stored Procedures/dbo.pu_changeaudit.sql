...
create procedure [dbo].[pu_changeaudit] 
(@db sysname null)

as 
declare @sql varchar(max);

set @sql = 'exec sp_executesql @stmt=N''use ' + @db + ';' + char(10) +
'begin try  
declare @enable int; 
...
,       1 as start_time, 1 as event_class, 1 as event_subclass, 1 as object_type, 1 as server_name, 1 as login_name, 
1 as user_name, 1 as application_name, 1 as ddl_operation  
end catch;'',@params=N'''''
